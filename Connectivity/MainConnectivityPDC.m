...
SavingPath=fullfile(current_folder,'Connectivity_PDC/Results44ch/Order_p2/zscore1/');
...
outlineElc=[58,51,50,37,36,29,28,14,13,12,11,2,1];
outlineElc2=[58,55,54,53,52,51,50,37,36,29,28,14,13,12,11,2,1];
...
for ff=1:numel(eegfiles)
    ...
    disp('****************************************************************');
    ConnectivityPDC(dataN,p_order,wlength,woverlap,fband1,fband2,SavingPath,ID,fs);    
end
